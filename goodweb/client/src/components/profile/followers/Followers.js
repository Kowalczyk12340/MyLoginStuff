            ...
            <div className="d-flex justify-content-start">
              {followers.length > 0 && (
                <div
                  ...
                  className={`  m-2 px-3 py-2  h6   text-white  optionsFollowers ${
                    showComponent.followers && "default-color-dark text-light"
                  } `}
                >
                  Followers
              ...
              {following.length > 0 && (
                <div
                  ...
                  className={`  m-2 px-3 py-2  h6   text-white  optionsFollowers ${
                    showComponent.following && "default-color-dark text-light"
                  } `}
                >
                  Following
                  <span className="text-light small ml-1">
