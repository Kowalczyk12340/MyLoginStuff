        ...
        <ul className="list-group   list-group-flush settingOptions ">
          <li
            ...
            className={`list-group-item  border-0 mx-2 ${
              activeComponent.personal && "elegant-color text-light"
            }`}
          >
          ...
          <li
            ...
            className={`list-group-item  border-0 mx-2 ${
              activeComponent.hobbies && "elegant-color text-light"
            }`}
          >
          ...
          <li
            ...
            className={`list-group-item  border-0 mx-2 ${
              activeComponent.education && "elegant-color text-light"
            }`}
          >
          ...
          <li
            ...
            className={`list-group-item  border-0 mx-2 ${
              activeComponent.password && "elegant-color text-light"
            }`}
          >
            Change Password
          </li>
          <li
            ...
            className={`list-group-item  border-0 mx-2   ${
              activeComponent.email && "elegant-color text-light"
            }`}
          >
            Change Email
          </li>
          ...
          <li
            ...
            className={`list-group-item font-weight-bold border-bottom border-light d-flex align-items-center text-info overflow-auto  ${
              activeComponent.deleteAccount && "elegant-color text-light"
            }`}
          >
