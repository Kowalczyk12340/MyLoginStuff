      ...
      <animated.div style={fade}>
        ...
        <div className="d-flex flex row">
          <button
            ...
            className={`btn default-color-dark text-light rounded-top mb-4 ${
              showAll && "unique-color-dark border border-info  "
            }`}
          >
          ...
          <button
            ...
            className={`btn unique-color text-light rounded-top mb-4 ${
              add && "unique-color-dark border border-info"
            } `}
          >
            {" "}
